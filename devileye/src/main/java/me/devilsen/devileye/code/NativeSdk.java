package me.devilsen.devileye.code;
...
class NativeSdk {
     ...
     */
    public void onDecodeCallback(String content, int scanType) {
        if (readCodeListener != null) {
            readCodeListener.onReadCodeResult(new CodeResult(content, scanType));
        }
    }
